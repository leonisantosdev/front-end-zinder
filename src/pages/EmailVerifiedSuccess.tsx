...
export function EmailVerifiedSuccess() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-white">
      <Button onClick={() => navigate('/login')} variant="outline" className="absolute left-0 top-0 mt-5 ml-2 bg-transparent">
        <ChevronLeft />
      </Button>
      <div className="rounded-2xl p-8 max-w-md w-full text-center">
        <h1 className="text-3xl font-bold mb-8">E-mail verificado com sucesso!</h1>
