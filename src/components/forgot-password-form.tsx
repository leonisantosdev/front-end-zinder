  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-center text-sm">
              {t('forgotPassword.alreadyHaveAccount')} <a onClick={() => navigate('/login')} className="underline underline-offset-4 hover:cursor-pointer hover:text-gray-400">{t('forgotPassword.signin')}</a> {t('forgotPassword.or')} <a onClick={() => navigate('/register')} className="underline underline-offset-4 hover:cursor-pointer hover:text-gray-400">{t('forgotPassword.signup')}</a>
            </div>
          </div>
          <div className="flex flex-col gap-6">
      ...
      <div className="text-muted-foreground *:[a]:hover:text-primary text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4">
        {t('forgotPassword.terms.t1')} <a href="#">{t('forgotPassword.terms.t2')}</a> {t('forgotPassword.terms.t3')} <a href="#">{t('forgotPassword.terms.t4')}</a>.
      </div>
    </div>
  )
}
